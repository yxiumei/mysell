...
<#--<meta charset="UTF-8">-->
<#--<title>订单列表</title>-->
<#--&lt;#&ndash;<script src="http://www.jq22.com/jquery/jquery-1.10.2.js"></script>&ndash;&gt;-->
<#--&lt;#&ndash;<script src="https://cdn.bootcss.com/twitter-bootstrap/3.0.1/js/bootstrap.min.js"></script>&ndash;&gt;-->
...
<#--&lt;#&ndash;<td>${orderDto.updateTime?string('yyyy.MM.dd HH:mm:ss')}</td>&ndash;&gt;-->
<#--<td>详情</td>-->
<#--<td>-->
